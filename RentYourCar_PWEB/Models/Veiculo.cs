...
namespace RentYourCar_PWEB.Models
{
    ...
    public class Veiculo
    {
        ...
        [Required] public virtual Categoria Categoria { get; set; } //pesado, ligeiro, ligeiro de mecadorias, etc
        ...
        [NotMapped] private SelectList CombustivelDropDownList { get; set; }
        [NotMapped] private SelectList CategoriaDropDownList { get; set; }
    }
}